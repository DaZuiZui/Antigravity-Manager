                    ...
                    <div className="space-y-1.5">
                        <div className="flex justify-between items-baseline">
                            <span className="text-xs font-medium text-gray-600 dark:text-gray-400 flex items-center gap-1">
                                {(account.protected_models?.includes('gemini-3-pro-high') || account.protected_models?.includes('gemini-3.1-pro-high') || account.protected_models?.includes('gemini-3.6-pro-high')) && <Lock className="w-2.5 h-2.5 text-rose-500" />}
                                {geminiProDisplayName}
                            </span>
